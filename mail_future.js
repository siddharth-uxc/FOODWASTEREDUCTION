...
const firebaseConfig = {
  ...
  function submitForm(e){
    ...
    var Date_of_Donation = getInputVal('Date_of_Donation');
  
    // Save message
    saveMessage(name, PinCode, email, phone, Address,Date_of_Donation);
  ...
  function saveMessage(name, PinCode, email, phone, Address,Date_of_Donation){
